...
class Options():
    def __init__(self):
        ...
        eval_arg.add_argument("--ngf", type=int, default=128,
                                help="number of generator filter channels, default 128")
        #eval_arg.add_argument("--content-image", type=str, required=False,
                                #help="path to content image you want to stylize")
        eval_arg.add_argument("--style-image", type=str, default="images/21styles/Robert_Delaunay,_1906,_Portrait.jpg",
                                help="path to style-image")
